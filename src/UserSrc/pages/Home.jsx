...
const products = [
  {
    ...
    image:"../src/UserSrc/assets/transparent/pink.png",
  },
  {
    ...
    image:"../src/UserSrc/assets/transparent/white.png",
  ...
  },
  {
    ...
    image:"../src/UserSrc/assets/transparent/red.png",
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 lg:gap-14 h-auto md:h-72">
        ...
        <div className="relative rounded-lg overflow-hidden h-64 md:h-auto">
          <img
            ...
            src="../src/UserSrc/assets/vanilla musk.jpg"
            alt="New Product"
        ...
        <div className="relative rounded-lg overflow-hidden h-64 md:h-auto">
          <img
            ...
            src="../src/UserSrc/assets/hydration oils.jpg"
...
export default function HomePage() {
  ...
  <div className="scroll-smooth">
      <div className="min-h-screen bg-[url('../src/UserSrc/assets/banner.svg')] w-full bg-no-repeat bg-cover -mt-20">
        <HeroSection />
      </div>
      <div>
        <Categories />
